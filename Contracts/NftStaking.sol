...
contract NftStaking is Ownable, ERC721Holder {
    ...
    uint256 public openedTill;
    
    uint256 constant stakingTime = 1800 seconds; // minimum nft lock time
    uint256  token = 10e18; // tokens per days
    ...
    constructor(IERC721 _nft, IRewardToken _rewardsToken,uint256 _openedAt,uint256 _openedTill,uint256 _rewardPerDay ) {
        nft = _nft;
    ...
    function _stake(address _user, uint256 _tokenId) internal {
        ...
        require((openedTill>block.timestamp),"Staking is closed");
        require(
    ...
    function claimReward(address _user) public {
        ...
        rewardsToken.transfer(_user, stakers[_user].balance);
