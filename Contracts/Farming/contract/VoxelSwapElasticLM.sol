...
import {IVoxelSwapElasticLM} from '../interfaces/liquidityMining/IVoxelSwapElasticLM.sol';
import {IVoxelRewardLockerV2} from '../interfaces/liquidityMining/IVoxelRewardLockerV2.sol';
...
contract VoxelSwapElasticLM is IVoxelSwapElasticLM, AccessControl, LMHelper, ReentrancyGuard {
  ...
  IVoxelRewardLockerV2 public immutable rewardLocker;
  ...
  constructor(IERC721 _nft, IVoxelRewardLockerV2 _rewardLocker) {
    nft = _nft;
